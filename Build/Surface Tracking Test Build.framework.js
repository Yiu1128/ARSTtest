...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_on_start_ar')) {
        Object.defineProperty(Module['ready'], '_on_start_ar', { configurable: true, get: function() { abort('You are getting _on_start_ar on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_on_start_ar', { configurable: true, set: function() { abort('You are setting _on_start_ar on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_on_start_vr')) {
        Object.defineProperty(Module['ready'], '_on_start_vr', { configurable: true, get: function() { abort('You are getting _on_start_vr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_on_start_vr', { configurable: true, set: function() { abort('You are setting _on_start_vr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_on_end_xr')) {
        Object.defineProperty(Module['ready'], '_on_end_xr', { configurable: true, get: function() { abort('You are getting _on_end_xr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_on_end_xr', { configurable: true, set: function() { abort('You are setting _on_end_xr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_on_xr_capabilities')) {
        Object.defineProperty(Module['ready'], '_on_xr_capabilities', { configurable: true, get: function() { abort('You are getting _on_xr_capabilities on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_on_xr_capabilities', { configurable: true, set: function() { abort('You are setting _on_xr_capabilities on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var ASM_CONSTS = {
  2933408: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2933469: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2933533: function() {return Module.webglContextAttributes.powerPreference;},  
 2933591: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2933646: function($0) {performance.now = function() { return $0; };},  
 2933694: function($0) {performance.now = function() { return $0; };},  
 2933742: function() {performance.now = Module['emscripten_get_now_backup'];}
};
